...
$sql=db_create_sql("SELECT * FROM menu_monan {where}   LIMIT {$paging['start']}, {$paging['limit']}",array('loai_mon_an' => 'trang mieng'));
...
<table cellspacing="0" cellpadding="0" class="form">
	...
	<tbody>
 <?php //vị trí thứ 2. code hiển thị người dùng bởi vì phía trên đã lấy dữ liệu ở biến user rồi! nên ta cho nó giống với $item luôn . nghĩa là 2 biến đã có giá trị như nhau rồi?>
